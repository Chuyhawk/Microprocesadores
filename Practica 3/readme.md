# Práctica 3 - Control de Display de 7 Segmentos

En esta práctica se trabajó con un display de 7 segmentos para visualizar información generada por el microcontrolador PIC16F887. El objetivo fue comprender el funcionamiento de este tipo de dispositivos y la forma en que los diferentes segmentos pueden activarse para representar números y caracteres. Las actividades permitieron reforzar el control de salidas digitales y la implementación de patrones de visualización mediante programación embebida.

_Hardware utilizado_ 
- Microcontrolador PIC16F887
- Programador PICkit
- Display de 7 segmentos con punto decimal
- Protoboard
